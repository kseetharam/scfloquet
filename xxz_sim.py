...
if __name__ == "__main__":
  ...
  N = 2  # number of qubits. If N < 4, assumes a line of qubits. If N > 4, assumes a square grid of qubits of size sqrt(N) x sqrt(N)
  ...
  Delta_eff = 1.0  # anisotropy of effective XXZ Hamiltonian (in units of J_eff); leads to well-defined pulse times for values between ~[0.1, 2]
